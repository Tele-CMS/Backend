...
namespace HC.Patient.Web.Migrations
{
    ...
    [Migration("20210623073257_AddedNewColumnsIsIsUrgentCareAppointmentToTablePatientAppointment")]
    partial class AddedNewColumnsIsIsUrgentCareAppointmentToTablePatientAppointment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterQuestionnaireTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("QuestionnaireTypeID");
                    ...
                    b.ToTable("MasterQuestionnaireTypes");
                });
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientAppointment", b =>
                {
                    ...
                    b.Property<bool?>("IsUrgentCareAppointment");
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientEncounterNotes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id");
                    ...
                    b.Property<string>("EncounterNotes");
                    ...
                    b.ToTable("PatientEncounterNotes");
                });
            ...
            modelBuilder.Entity("HC.Patient.Entity.Payments.ProviderCancellationRules", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("UptoHour");

                    b.HasKey("Id");

                    b.HasIndex("StaffId");

                    b.ToTable("ProviderCancellationRules");
                });
            ...
            modelBuilder.Entity("HC.Patient.Entity.ProviderQuestionnaireAsnwers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProviderQuestionnaireAsnwerId");

                    b.Property<string>("Answer");

                    b.Property<int>("PatientAppointmentId");

                    b.Property<int>("ProviderQuestionnaireControlId");

                    b.Property<int?>("ProviderQuestionnaireControlsId");

                    b.HasKey("Id");

                    b.HasIndex("PatientAppointmentId");

                    b.HasIndex("ProviderQuestionnaireControlsId");

                    b.ToTable("ProviderQuestionnaireAsnwers");
                });

            modelBuilder.Entity("HC.Patient.Entity.ProviderQuestionnaireControls", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProviderQuestionnaireControlId");
                    ...
                    b.Property<int>("QuestionnaireTypeControlId");
                    ...
                    b.HasIndex("QuestionnaireTypeControlId");

                    b.ToTable("ProviderQuestionnaireControls");
                });

            modelBuilder.Entity("HC.Patient.Entity.ProviderQuestionnaireQuestions", b =>
                {
                    ...
                    b.Property<string>("QuestionNameName")
                        .IsRequired()
                    ...
                    b.ToTable("ProviderQuestionnaireQuestions");
                });

            modelBuilder.Entity("HC.Patient.Entity.ProviderQuestionnaires", b =>
                {
                    b.Property<int>("QuestionnareId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("QuestionnnaireName")
                        .IsRequired()
                        .HasColumnType("varchar(1500)");
                    ...
                    b.ToTable("ProviderQuestionnaires");
                });

            modelBuilder.Entity("HC.Patient.Entity.QuestionnaireControls", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("QuestionnaireControlID");
                    ...
                    b.ToTable("QuestionnaireControls");
                });

            modelBuilder.Entity("HC.Patient.Entity.QuestionnaireOptions", b =>
                {
            ...
            modelBuilder.Entity("HC.Patient.Entity.QuestionnaireTypeControls", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("QuestionnaireTypeControlID");
                    ...
                    b.Property<int>("QuestionnaireControlId");
                    ...
                    b.HasIndex("QuestionnaireControlId");

                    b.HasIndex("QuestionnaireTypeId");

                    b.HasIndex("UpdatedBy");

                    b.ToTable("QuestionnaireTypeControls");
                });
            ...
            modelBuilder.Entity("HC.Patient.Entity.Staffs", b =>
                {
                    ...
                    b.Property<decimal?>("FollowUpPayRate");
                    ...
                    b.Property<decimal?>("UrgentCarePayRate");
            ...
            modelBuilder.Entity("HC.Patient.Entity.UserDocuments", b =>
                {
                    ...
                    b.Property<bool?>("IsProviderEducationalDocument");
            ...
            modelBuilder.Entity("HC.Patient.Entity.Payments.ProviderCancellationRules", b =>
                {
                    b.HasOne("HC.Patient.Entity.Staffs", "Staffs")
                        .WithMany("ProviderCancellationRules")
                        .HasForeignKey("StaffId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("HC.Patient.Entity.ProviderQuestionnaireAsnwers", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.ProviderQuestionnaireControls", "ProviderQuestionnaireControls")
                        .WithMany()
                        .HasForeignKey("ProviderQuestionnaireControlsId");
                });

            modelBuilder.Entity("HC.Patient.Entity.ProviderQuestionnaireControls", b =>
                {
                    b.HasOne("HC.Patient.Entity.QuestionnaireTypeControls", "QuestionnaireTypeControl")
                        .WithMany()
                        .HasForeignKey("QuestionnaireTypeControlId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("HC.Patient.Entity.ProviderQuestionnaireQuestions", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.ProviderQuestionnaires", "ProviderQuestionnaires")
                        .WithMany()
            ...
            modelBuilder.Entity("HC.Patient.Entity.QuestionnaireOptions", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.ProviderQuestionnaireQuestions", "ProviderQuestionnaireQuestions")
                        .WithMany()
            ...
            modelBuilder.Entity("HC.Patient.Entity.QuestionnaireTypeControls", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.QuestionnaireControls", "QuestionnaireControls")
                        .WithMany()
                        .HasForeignKey("QuestionnaireControlId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("HC.Patient.Entity.MasterQuestionnaireTypes", "MasterQuestionnaireTypes")
                        .WithMany()
                        .HasForeignKey("QuestionnaireTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
