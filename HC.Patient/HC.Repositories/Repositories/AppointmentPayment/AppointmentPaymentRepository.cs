...
namespace HC.Patient.Repositories.Repositories
{
    public class AppointmentPaymentRepository : RepositoryBase<AppointmentPayments>, IAppointmentPaymentRepository
    {
        ...
        public ClientPaymentgModel GetClientNetAppointmentPayment<ClientPaymentgModel>(int clietnId, TokenModel tokenModel) where ClientPaymentgModel : class, new()
        {
            SqlParameter[] parameters = {
                new SqlParameter("@OrganizationId", tokenModel.OrganizationID),
                new SqlParameter("@ClientId", clietnId),
          };
            return _context.ExecStoredProcedureListWithOutput<ClientPaymentgModel>(SQLObjects.PAY_GetClienPayments.ToString(), parameters.Length, parameters).FirstOrDefault();
        }
        ...
        public ClientAppointmentPastUpcomingModel GetPastUpcomingAppointment<ClientAppointmentPastUpcomingModel>(string locationIds, string staffIds, string patientIds, TokenModel tokenModel) where ClientAppointmentPastUpcomingModel : class, new()
        {
            SqlParameter[] parameters = {
                new SqlParameter("@OrganizationId", tokenModel.OrganizationID),
            ...
            return _context.ExecStoredProcedureListWithOutput<ClientAppointmentPastUpcomingModel>(SQLObjects.APT_GetPatientPastUpcomingAppointment.ToString(), parameters.Length, parameters).FirstOrDefault();
        }
        #endregion Client
    }
}
