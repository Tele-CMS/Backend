    ...
    public static class CommonMethods
    {
        ...
        public static string CreateImageUrl(HttpContext request, string directoy, string fileName)
       {
            try
            {
                ...
                if (File.Exists(webRootPath + directoy + fileName)) {
        ...
        public static string CreateHTTPRequest(string url, object data, string method, string contentType)
        {
            ...
            var newRequest = new RestRequest("v2/search?phrase=headache&sex=female&max_results=8&type=symptom", Method.GET);
            ...
            //request.("App-Key", CommonEnum.SymptomConfig.Symptom_SenderKey);
            //request.Headers.Add("App-Id=", CommonEnum.SymptomConfig.symptom_SenderId);
            //request.Credentials = new System.Net.NetworkCredential("jittnder.kumar@smartdatainc.net", "Smartdata");
            //request.Headers.Add("Access-Control-Allow-Origin", "*");
            //request.Headers.Add("Access-Control-Allow-Methods", "GET,HEAD,OPTIONS,POST,PUT.PATCH");
            //request.Headers.Add("Access-Control-Allow-Headers", "Authorization,DNT,Keep-Alive,User-Agent,X-Requested-With,Cache-Control,Content-Type,Model,App-Id,App-Key,User-Id,Interview-Id,Dev-Mode,Case-Id,app_id,app_key,Version");
            //request.Headers.Add("Access-Control-Allow-Credentials", "true");
            //request.Headers.Add("Access-Control-Request-Headers", " X-Requested-With, accept, content-type");
            //request.Headers.Add("Access-Control-Max-Age", "86400");
        ...
        #region Convert Iquerable to sql
        ...
        private static readonly FieldInfo QueryCompilationContextFactoryField = typeof(Microsoft.EntityFrameworkCore.Storage.Database).GetTypeInfo().DeclaredFields.Single(x => x.Name == "_queryCompilationContextFactory");
        ...
        public static string ToSql<TEntity>(this IQueryable<TEntity> query) where TEntity : class
        {
            ...
            var queryCompilationContextFactory = (Microsoft.EntityFrameworkCore.Query.IQueryCompilationContextFactory)QueryCompilationContextFactoryField.GetValue(database);
        ...
        #endregion Convert Iquerable to sql
